...
public class FileDatabase extends AbstractDatabase {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.crossroad.db.util.db.impl.AbstractDatabase#doOpenConnection()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.crossroad.db.util.db.impl.AbstractDatabase#doCloseConnection()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.crossroad.db.util.db.impl.AbstractDatabase#commit()
	 */
	@Override
