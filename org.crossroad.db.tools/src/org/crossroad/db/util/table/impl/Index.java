...
public class Index extends AbstractIndex implements IIndex {
	...
	/* (non-Javadoc)
	 * @see org.crossroad.db.util.table.IIndex#isUnique()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.crossroad.db.util.table.IIndex#getColumnSort()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.crossroad.db.util.table.IIndex#getFilterCond()
	 */
	@Override
